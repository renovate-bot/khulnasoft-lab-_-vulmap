...
// Client is a client for result retrieval from vulmap-cloud API
type Client struct {
	baseURL    string
	apiKey     string
...
const (
	...
	resultSize     = 100
	defaultBaseURL = "https://cloud-dev.vulmap.sh"
)
...
// New returns a vulmap-cloud API client
...
// AddScan adds a scan for templates and target to vulmap server
...
// GetResults gets results from vulmap server for an ID
