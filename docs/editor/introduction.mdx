...
[Vulmap Template Editor](https://templates.nuclei.sh) is a multi-functional cloud hosted tool designed for creating, running, and sharing Vulmap Templates. It's packed with helpful features for individual and professional users seeking to manage and execute templates.

The following table showcases the current and upcoming features:

| Feature                | Description and Use                                                                                                                                                                                                              | Availability              |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| **Editor**                | Experience something akin to using VS Code with our integrated editor, built on top of Monaco. This feature allows easy writing and modification of Vulmap Templates.                                                              | Free                      |
| **Optimizer**             | Leverage the in-built TemplateMan API to automatically lint, format, validate, and enhance your Vulmap Templates.                                                                                                                 | Free                      |
...
| **Cloud Storage**         | Store and access your Vulmap Templates securely anytime, anywhere using your account.                                                                                                                                             | Free                      |
| **Sharing**               | Share your templates for better collaboration by generating untraceable unique links.                                                                                                                                             | Free                      |
| **AI-Assistance**         | Employ AI to craft Vulmap Templates based on the context of specified vulnerabilities. This feature simplifies template creation and tailors them to minimize the time required for creation.                             | Free \*                   |
