...
| Feature                                  | Description                                                                                                                                                     |
| ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Extensive Template Library](#)          | Vulmap offers a vast collection of community-powered templates for targeted scans of various vulnerabilities and attack vectors.                                   |
...
| [Integration with CI/CD Pipelines](#)    | Seamlessly integrate Vulmap into CI/CD pipelines for automated security testing as part of the development and deployment process.                                |
...
| [Customizable Output Format](#)          | Configure the output format of Vulmap's scan results to suit your needs, including options for JSON, YAML, and more.                                            |
...
| [Authentication Support](#)              | Vulmap supports various authentication mechanisms, including HTTP basic authentication, JWT token authentication, and more.                                      |
| [Embedding custom code in templates `alpha`](#) | Execute custom code within Vulmap templates to incorporate user-defined logic, perform advanced scanning actions, and more.                               |
