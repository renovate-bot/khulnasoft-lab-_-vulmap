...
// RunVulmapTemplateAndGetResults returns a list of results for a template
func RunVulmapTemplateAndGetResults(template, url string, debug bool, extra ...string) ([]string, error) {
	return RunVulmapAndGetResults(true, template, url, debug, extra...)
}

// RunVulmapWorkflowAndGetResults returns a list of results for a workflow
func RunVulmapWorkflowAndGetResults(template, url string, debug bool, extra ...string) ([]string, error) {
	return RunVulmapAndGetResults(false, template, url, debug, extra...)
}

func RunVulmapAndGetResults(isTemplate bool, template, url string, debug bool, extra ...string) ([]string, error) {
	...
	return RunVulmapBareArgsAndGetResults(debug, nil, append([]string{
...
func RunVulmapBareArgsAndGetResults(debug bool, env []string, extra ...string) ([]string, error) {
	cmd := exec.Command("./vulmap")
...
// RunVulmapArgsAndGetResults returns result,and runtime errors
func RunVulmapWithArgsAndGetResults(debug bool, args ...string) ([]string, error) {
	cmd := exec.Command("./vulmap", args...)
	if debug {
		cmd.Args = append(cmd.Args, "-debug")
		cmd.Stderr = os.Stderr
		fmt.Println(cmd.String())
...
// RunVulmapArgsAndGetErrors returns a list of errors in vulmap output (ERR,WRN,FTL)
func RunVulmapArgsAndGetErrors(debug bool, env []string, extra ...string) ([]string, error) {
	cmd := exec.Command("./vulmap")
	extra = append(extra, ExtraDebugArgs...)
	cmd.Env = append(os.Environ(), env...)
	cmd.Args = append(cmd.Args, extra...)
...
// RunVulmapArgsWithEnvAndGetErrors returns a list of errors in vulmap output (ERR,WRN,FTL)
func RunVulmapArgsWithEnvAndGetResults(debug bool, env []string, extra ...string) ([]string, error) {
	cmd := exec.Command("./vulmap")
	extra = append(extra, ExtraDebugArgs...)
	cmd.Env = append(os.Environ(), env...)
	cmd.Args = append(cmd.Args, extra...)
...
// RunVulmapBinaryAndGetLoadedTemplates returns a list of results for a template
func RunVulmapBinaryAndGetLoadedTemplates(vulmapBinary string, debug bool, args []string) (string, error) {
	cmd := exec.Command(vulmapBinary, args...)
	cmd.Args = append(cmd.Args, "-duc") // disable auto updates
	if debug {
		cmd.Args = append(cmd.Args, "-debug")
		fmt.Println(cmd.String())
...
func RunVulmapBinaryAndGetCombinedOutput(debug bool, args []string) (string, error) {
