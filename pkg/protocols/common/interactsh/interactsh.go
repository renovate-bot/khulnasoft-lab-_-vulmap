...
import (
	...
	"github.com/khulnasoft-lab/vulmap/pkg/protocols/common/helpers/writer"
...
// MakeResultEventFunc is a result making function for vulmap
...
// RequestEvent is the event for a network request sent by vulmap.
