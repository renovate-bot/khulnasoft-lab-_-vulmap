...
func (g *PayloadGenerator) validate(payloads map[string]interface{}, templatePath string) error {
	for name, payload := range payloads {
		...
		case string:
			...
			// if file already exists in vulmap-templates directory, skip any further checks
			...
			// ex: template-path: /home/user/vulmap-templates/cves/2020/CVE-2020-1234.yaml
			// then we check if helper file "my-payload.txt" exists at below paths:
			// 1. /home/user/vulmap-templates/cves/2020/my-payload.txt
			// 2. /home/user/vulmap-templates/cves/my-payload.txt
			// 3. /home/user/vulmap-templates/my-payload.txt
