...
type Action struct {
	...
	//
	//   Per action arguments are described in detail [here](https://vulmap.khulnasoft-lab.io/templating-guide/protocols/headless/).
	...
	//   which can be matched upon by vulmap. An Example template [here](https://github.com/khulnasoft-lab/vulmap-templates/blob/main/headless/prototype-pollution-check.yaml).
