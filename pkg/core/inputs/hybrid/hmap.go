...
// for vulmap that can either stream or store results using different kv stores.
package hybrid
...
// Input is a hmap/filekv backed vulmap Input provider
type Input struct {
	ipOptions         *ipOptions
	inputCount        int64
	dupeCount         int64
...
// New creates a new hmap backed vulmap Input Provider
