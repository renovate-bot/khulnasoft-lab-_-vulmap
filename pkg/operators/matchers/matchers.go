...
type Matcher struct {
	...
	// description: |
	//   DSL are the dsl expressions that will be evaluated as part of vulmap matching rules.
	//   A list of these helper functions are available [here](https://vulmap.khulnasoft-lab.io/templating-guide/helper-functions/).
	// examples:
	...
	DSL []string `yaml:"dsl,omitempty" json:"dsl,omitempty" jsonschema:"title=dsl expressions to match in response,description=DSL are the dsl expressions that will be evaluated as part of vulmap matching rules"`
	// description: |
	...
	XPath []string `yaml:"xpath,omitempty" json:"xpath,omitempty" jsonschema:"title=xpath queries to match in response,description=xpath are the XPath queries that will be evaluated against the response part of vulmap matching rules"`
	// description: |
