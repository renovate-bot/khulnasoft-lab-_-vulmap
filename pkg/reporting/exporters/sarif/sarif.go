...
// addToolDetails adds details of static analysis tool (i.e vulmap)
func (exporter *Exporter) addToolDetails() {
	driver := sarif.ToolComponent{
		...
		FullName:        "Vulmap v" + config.Version,
		SemanticVersion: "v" + config.Version,
		DownloadURI:     "https://github.com/khulnasoft-lab/vulmap/releases",
