...
// InternalEvent is an internal output generation structure for vulmap.
...
// ResultEvent is a wrapped result event for a single vulmap output.
type ResultEvent struct {
	// Template is the relative filename for the template
	Template string `json:"template,omitempty"`
	// TemplateURL is the URL of the template for the result inside the vulmap
