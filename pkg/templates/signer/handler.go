...
const (
	CertType           = "PD VULMAP USER CERTIFICATE"
	PrivateKeyType     = "PD VULMAP USER PRIVATE KEY"
	CertFilename       = "vulmap-user.crt"
	PrivateKeyFilename = "vulmap-user-private-key.pem"
	CertEnvVarName     = "VULMAP_USER_CERTIFICATE"
	PrivateKeyEnvName  = "VULMAP_USER_PRIVATE_KEY"
)

var (
	ErrNoCertificate   = fmt.Errorf("vulmap user certificate not found")
	ErrNoPrivateKey    = fmt.Errorf("vulmap user private key not found")
